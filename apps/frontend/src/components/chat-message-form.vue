  ...
  <div class="flex flex-col gap-2.5 bg-[#111111] p-2.5 relative">
    ...
    >
      <Textarea
        ...
        @paste="console.log"
        class="pr-12 min-h-8 max-h-20 resize-none bg-[#181818] focus-visible:ring-offset-0 focus-visible:ring-blue-500 transition-[box-shadow,border-color] hover:border-white/20 border-white/15 px-3 placeholder:text-white/50 rounded-md focus-visible:border-blue-500"
        :rows="isSmall ? 1 : 3"
