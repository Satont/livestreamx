...
import Player from '~/components/Stream/Player.vue'
import { reverseStreamChatDirection } from '~/composables/reverse-stream-chat-direction'
</script>
...
<template>
  ...
  >
    <main class="h-[40dvh] xl:h-full xl:flex-1 overflow-y-auto w-full">
      <ClientOnly>
